...
/** Contact — centred CTA + social links */
export function Contact() {
  return (
    <section id="contact">
      <p className="section-label reveal" style={{ justifyContent: 'center' }}>Get In Touch</p>
      <div className="contact-big reveal">LET&apos;S <span>BUILD</span><br />SOMETHING.</div>
      <p className="contact-sub reveal">Open to SDE · Full Stack · Backend roles at high-scale companies</p>
